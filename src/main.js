...
Vue.prototype.$M = M
Vue.prototype.$headers = () => ({headers: {Authorization: `Bearer ${jsCookie.getJSON('4u7h3n71c4710n').token}`}})
Vue.prototype.$baseUrl = config.axiosConf.baseURL

// COMPONENTS
import home from './components/main/home.vue'
import nav from './components/layout/nav_.vue'
import notifications from './components/layout/notifications_.vue'
